...
const validOptions = {
  ...
  // Estas opciones se utilizan para Pool
  connectionLimit: 1,
  Promise: 1,
  queueLimit: 1,
...
class ConnectionConfig {
  constructor(options) {
    ...
    for (const key in options) {
      ...
      if (validOptions[key] !== 1) {
		...
		// REVISIÓN: ¿Debería emitirse de alguna manera?
        // eslint-disable-next-line no-console
		// eslint - deshabilitar - siguiente - línea no - consola
        console.error(
    ...
    if (
	  ...
	  // admite estrictamente las zonas horarias especificadas por mysqljs / mysql:
	  ...
	  // SqlStrings vuelve a UTC en una zona horaria no válida
      this.timezone = 'Z';
    } else {
    ...
    if (this.timezone[0] === ' ') {
      ...
      // connection string..
	  // "+" es un carácter codificado en URL para el espacio, por lo que se traduce al espacio cuando se proporciona una cadena de conexión.
    ...
    if (this.ssl) {
	  ...
	  // Rechazo predeterminado No autorizado a verdadero
  ...
  static mergeFlags(default_flags, user_flags) {
	...
	// agregar banderas predeterminadas a menos que estén "en la lista negra"
