...
<a href="/setlang/{{$k}}"><i data-lang-code="{{$k}}" role="button">
...
<img class="providers-mob__icon-img providers-mob__icon-img--pragmaticplay" src="https://cdn2.softswiss.net/woocasino/logos/providers_small/color/{{$category->href}}.svg">
</span>
