...
<a class="header__logo-link" scroll-up="" href="/"> <img class="header__logo-img" src="/woocasino/resources/images/logo.png" alt="total.casino"> </a>
</div>
...
{{ isset($currency) ? $currency : 'PLN' }}</span></div>
...
@endif
@if( settings('use_new_categories'))
<li class="header-menu__item ng-scope">
...
{{ isset($currency) ? $currency : 'PLN' }}</span></li>
...
{{ isset($currency) ? $currency : 'PLN' }}</span></li>
<li class="font-black"><span class="info-name">@lang('app.pyour_wager'):</span> <span class="info-value wager">{{ number_format(auth()->user()->wager, 0, '.', '') }}
</span></li>
...
{{ isset($currency) ? $currency : 'PLN' }}</span>
</li>
@endif
</ul>
</div>
...
{!! Form::open(['route' => 'frontend.profile.balance.post', 'method' => 'POST']) !!}
<div class="modal__content contentpay">
<div class="deposit__inner" style="grid-template-columns: 35% 55%;">
<div class="input">
<button style="min-width: 100%;" class="popup__button button">zł PLN &gt;&gt;&gt;</button>
</div>
<div class="modal__input input">
<input type="text" name="summ" class="modal__input-inner input__inner" placeholder="@lang('app.enter_place_holder')" required="" style="width:100%">
</div>
</div>
...
<div class="modal__input input">
<input type="text" id="cctextboxid1" name="txtamount" placeholder="@lang('app.enter_place_holder')" class="modal__input-inner input__inner" style="">
</div>
<div class="modal__input input">
<select name="txtcurrency" id="currency1" class="modal__input-inner input__inner" style="width: 200px;">
...
<input type="text" name="amount" class="modal__input-inner input__inner" placeholder="@lang('app.enter_place_holder')" required style="width:100%">
</div>
...
<div class="row">
<div class="modal__input input">
<input type="text" id="cctextboxid" name="cctextbox" placeholder="@lang('app.enter_place_holder')" class="modal__input-inner input__inner" required>
</div>
<div class="modal__input input">
...
<div class="row">
<div class="modal__input input">
<input type="text" id="cctextboxid1" name="txtamount" placeholder="@lang('app.enter_place_holder')" class="modal__input-inner input__inner" style="background-color: rgba(255, 255, 255, 0.3);color:#a5a3bd">
</div>
<div class="modal__input input">
<select name="txtcurrency" id="currency1" class="modal__input-inner input__inner" style="background-color: rgba(255, 255, 255, 0.3);">
<option value="USD">USD</option>
<option value="EUR">EUR</option>
</select>
</div>
