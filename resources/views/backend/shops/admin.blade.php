                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php 
                                    $old_username = $role_name.'.username';
                                    $old_balance = $role_name.'.balance';
                                    $old_password = $role_name.'.password';
                                    ?>
                                    <input type="text" class="form-control" id="username" name="{{ $role_name }}[username]" placeholder="(@lang('app.optional'))" value="{{ old($old_username) }}">
                                </div>
                            </div>
                            @if($role_name != 'cashier' && $role_name != 'manager')
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="balance" name="{{ $role_name }}[balance]" value="{{ old($old_balance)?:0 }}">
                                    </div>
                                </div>
                            @endif
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" name="{{ $role_name }}[password]" value="{{ old($old_password) }}">
                                </div>
                            </div>
                        </div>
                    @endif
