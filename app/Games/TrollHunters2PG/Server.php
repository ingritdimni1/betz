                                            ...
                                            for ($k = 0; $k < 10; $k++) {
                                                ...
                                                for ($j = 0; $j < count($slotSettings->SymbolGame); $j++) {
                                                    ...
                                                    if ($csym == $scatter || ! isset($slotSettings->Paytable['SYM_'.$csym])) {
                                                        ...
                                                        } elseif (($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild))) {
                                                            $tmpWin = $slotSettings->Paytable['SYM_'.$csym][3] * $betline * $currentMpl;
                                                            if ($cWins[$k] < $tmpWin) {
                                                                $startReel = 2;
                                                                if ($dir == 0) {
                                                        ...
                                                        } elseif (($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild))) {
                                                            $tmpWin = $slotSettings->Paytable['SYM_'.$csym][3] * $betline * $currentMpl;
                                                            if ($cWins[$k] < $tmpWin) {
                                                                $startReel = 3;
                                                                if ($dir == 0) {
