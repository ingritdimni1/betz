                    ...
                    try {
                        ...
                        if (isset($postData['ID']) && $postData['ID'] == 41020 && $slotSettings->GetGameData('FeiCuiGongZhuJPPTMBonusStart')) {
                            ...
                            if ($postData['type'] == 'spin') {
                                ...
                                if ($reelPos[0] == 0) {
                                    $curJID = 1;
                                } elseif ($reelPos[0] >= 1 && $reelPos[0] <= 2) {
                                    $curJID = 2;
                                } elseif ($reelPos[0] >= 3 && $reelPos[0] <= 5) {
                                    $curJID = 3;
                                } elseif ($reelPos[0] >= 6 && $reelPos[0] <= 9) {
                                    $curJID = 4;
                                }
                        ...
                        if (isset($postData['index'])) {
                            ...
                            } elseif ($slotSettings->GetGameData('FeiCuiGongZhuJPPTMBonusStep') == 1) {
                            ...
                            for ($i = 0; $i <= 2000; $i++) {
                                ...
                                if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                    ...
                                    if ($slotSettings->increaseRTP && $winType == 'win' && $totalWin < ($minWin * $postData['bet'])) {
                                        ...
                                        } elseif ($totalWin <= $spinWinLimit && $winType == 'bonus2') {
