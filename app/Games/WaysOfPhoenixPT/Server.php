                        ...
                        if (isset($postData['spinType'])) {
                            ...
                            for ($i = 0; $i <= 2000; $i++) {
                                ...
                                if ($gridState['b_'.($betLine * 100)] == 0) {
                                    ...
                                    $reels['reel5'][3] = 'EMPTY';
                                    $reels['reel5'][4] = 'EMPTY';
                                } elseif ($gridState['b_'.($betLine * 100)] == 1) {
                                    $reels['reel1'][0] = 'EMPTY';
                                    $reels['reel1'][4] = 'EMPTY';
                                    $reels['reel2'][0] = 'EMPTY';
                                    $reels['reel2'][4] = 'EMPTY';
                                    ...
                                    $reels['reel5'][3] = 'EMPTY';
                                    $reels['reel5'][4] = 'EMPTY';
                                } elseif ($gridState['b_'.($betLine * 100)] == 2) {
                                    $reels['reel1'][0] = 'EMPTY';
                                    $reels['reel1'][4] = 'EMPTY';
                                    $reels['reel2'][0] = 'EMPTY';
                                    $reels['reel2'][4] = 'EMPTY';
                                    ...
                                    $reels['reel5'][0] = 'EMPTY';
                                    $reels['reel5'][4] = 'EMPTY';
                                } elseif ($gridState['b_'.($betLine * 100)] == 3) {
                                    $reels['reel2'][0] = 'EMPTY';
                                    $reels['reel2'][4] = 'EMPTY';
                                    $reels['reel4'][0] = 'EMPTY';
                                    $reels['reel4'][4] = 'EMPTY';
                                    $reels['reel5'][0] = 'EMPTY';
                                    $reels['reel5'][4] = 'EMPTY';
                                } elseif ($gridState['b_'.($betLine * 100)] == 4) {
                                    $reels['reel2'][0] = 'EMPTY';
                                    $reels['reel2'][4] = 'EMPTY';
                                    $reels['reel4'][0] = 'EMPTY';
                                    $reels['reel4'][4] = 'EMPTY';
                                ...
                                if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                    ...
                                    if ($slotSettings->increaseRTP && $winType == 'win' && $totalWin < ($minWin * $postData['bet'])) {
                                        ...
                                        } elseif (($scattersCount >= 3 || $scattersCount >= 2 && $postData['slotEvent'] == 'freespin') && $winType != 'bonus') {
                            ...
                            } elseif ($gridState['b_'.($betLine * 100)] > 0 && $postData['slotEvent'] != 'freespin') {
                                $gridState['b_'.($betLine * 100)]--;
                            }
                            $reportWin = $totalWin;
                            if ($postData['slotEvent'] == 'freespin') {
