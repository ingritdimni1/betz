                ...
                \DB::transaction(function () use ($game) {
                    try {
                        ...
                        if (isset($postData['gameData'][1]) && ($postData['gameData'][1] == 'WEB' || $postData['gameData'][1] == 'MOBILE')) {
                            ...
                            exit();
                        } elseif (isset($postData['gameData'][1])) {
                            ...
                            if ($jsnArr['Type'] == 3 && $jsnArr['ID'] == 31) {
                                $aid = 'bet';
                            } elseif ($jsnArr['Type'] == 3 && $jsnArr['ID'] == 32) {
                                $aid = 'spin_accept';
                            } elseif ($jsnArr['Type'] == 3 && $jsnArr['ID'] == 44) {
                                $aid = 'bonus_accept';
                            } elseif ($jsnArr['Type'] == 3 && $jsnArr['ID'] == 45) {
                                $aid = 'bonus_step';
                            } elseif ($jsnArr['Type'] == 3 && $jsnArr['ID'] == 46) {
                                $aid = 'bonus_end';
                            }
                        }
                        if ($aid == 'bet') {
                            ...
                            case 'bet':
                                ...
                                for ($i = 0; $i <= 2000; $i++) {
                                    ...
                                    if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                        ...
                                        } elseif ($scattersCount2 >= 3 && $winType == 'bonus' && $spinWinLimit < ($totalWin + (2 * $allbet))) {
                                        } elseif (($scattersCount >= 3 || $scattersCount2 >= 3) && $winType != 'bonus') {
