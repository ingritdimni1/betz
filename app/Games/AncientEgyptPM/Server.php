        ...
        public function get($request, $game)
        {
            \DB::transaction(function () use ($game) {
                try {
                    ...
                    if ($postData['slotEvent'] == 'doInit') {
                    ...
                    } elseif ($postData['slotEvent'] == 'doBonus') {
                        ...
                        if ($bstate == 0) {
                            ...
                            for ($i = 0; $i <= 200; $i++) {
                                shuffle($winsArr);
                                if ($winsArr[0] > 12 || $winsArr[0] <= 10 && $bank >= $winsArr[0] * $curBet) {
                                    break;
                                }
                            }
                            $statusStr = [
                    ...
                    } elseif ($postData['slotEvent'] == 'doMysteryScatter') {
                        $Balance = $slotSettings->GetBalance();
                        $rSym = rand(3, 11);
                    ...
                    } elseif ($postData['slotEvent'] == 'doCollect' || $postData['slotEvent'] == 'doCollectBonus') {
                        $Balance = $slotSettings->GetBalance();
                    ...
                    } elseif ($postData['slotEvent'] == 'doSpin') {
                                    ...
                                    if ($csym == $scatter || ! isset($slotSettings->Paytable[$csym])) {
                                        ...
                                        if (($s[0] == $csym || $wild == $s[0]) && ($s[1] == $csym || $wild == $s[1]) && ($s[2] == $csym || $wild == $s[2])) {
                                            if ($wild == $s[0] && $wild == $s[1] && $wild == $s[2]) {
                                                $mpl = 0;
                                            } elseif ($wild == $s[0] || $wild == $s[1] || $wild == $s[2]) {
                                        ...
                                        if (($s[0] == $csym || $wild == $s[0]) && ($s[1] == $csym || $wild == $s[1]) && ($s[2] == $csym || $wild == $s[2]) && ($s[3] == $csym || $wild == $s[3])) {
                                            if ($wild == $s[0] && $wild == $s[1] && $wild == $s[2] && $wild == $s[3]) {
                                                $mpl = 0;
                                            } elseif ($wild == $s[0] || $wild == $s[1] || $wild == $s[2] || $wild == $s[3]) {
                                                $mpl = $slotSettings->slotWildMpl;
                                            } else {
                                                $mpl = 1;
                                            }
                                        ...
                                        if (($s[0] == $csym || $wild == $s[0]) && ($s[1] == $csym || $wild == $s[1]) && ($s[2] == $csym || $wild == $s[2]) && ($s[3] == $csym || $wild == $s[3]) && ($s[4] == $csym || $wild == $s[4])) {
                                            if ($wild == $s[0] && $wild == $s[1] && $wild == $s[2] && $wild == $s[3] && $wild == $s[4]) {
                                                $mpl = 0;
                                            } elseif ($wild == $s[0] || $wild == $s[1] || $wild == $s[2] || $wild == $s[3] || $wild == $s[4]) {
                                                $mpl = $slotSettings->slotWildMpl;
                                            } else {
                                                $mpl = 1;
                                            }
