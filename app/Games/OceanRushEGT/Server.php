                            ...
                            case 'bet':
                                ...
                                for ($i = 0; $i <= 2000; $i++) {
                                    ...
                                    if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                        ...
                                        } elseif ($totalWin + $scattersWin3 <= $spinWinLimit && $winType == 'bonus') {
                                        ...
                                        } elseif ($totalWin > 0 && $totalWin + $scattersWin3 <= $spinWinLimit && $winType == 'win') {
                                            $cBank = $slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : ''));
                                            if ($cBank < $spinWinLimit) {
                                                $spinWinLimit = $cBank;
                                            } else {
                                        ...
                                        } elseif ($totalWin + $scattersWin3 == 0 && $winType == 'none') {
                                            break;
                                        }
                                    }
                                }
