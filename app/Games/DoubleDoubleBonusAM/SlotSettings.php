    ...
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits, $tipMode)
        {
            ...
            for ($i = 2; $i <= 14; $i++) {
                ...
                } elseif ($cardsAmount[$i] == 4 && in_array($i, [
                    2,
                    3,
                    4,
                ...
                } elseif ($cardsAmount[$i] == 4 && in_array($i, [14])) {
                ...
                } elseif ($cardsAmount[$i] == 1 && $cardsAmount[$i + 1] == 1 && $cardsAmount[$i + 2] == 1 && $cardsAmount[$i + 3] == 1 && $cardsAmount[$i + 4] == 1) {
            ...
            if ($tipMode && $pay == 0) {
                ...
                for ($i = 2; $i <= 14; $i++) {
                    if ($cardsAmount[$i] == 1 && $i >= 11) {
                        ...
                        $hcCount++;
                    } elseif ($cardsAmount[$i] == 2 && $i < 11) {
                        $combinations[3]['amount'] = 1;
                        $combinations[3]['cards'][0] = $i;
                    } elseif ($cardsAmount[$i] == 1 && $cardsAmount[$i + 1] == 1 && $cardsAmount[$i + 2] == 1 && $cardsAmount[$i + 3] == 1) {
                        $combinations[4]['amount'] = 1;
                        $combinations[4]['cards'][0] = $i;
                        $combinations[4]['cards'][1] = $i + 1;
                        $combinations[4]['cards'][2] = $i + 2;
                        $combinations[4]['cards'][3] = $i + 3;
                    } elseif ($cardsAmount[$i] == 1 && $cardsAmount[$i + 1] == 1 && $cardsAmount[$i + 3] == 1 && $cardsAmount[$i + 4] == 1) {
                        $combinations[4]['amount'] = 1;
                        $combinations[4]['cards'][0] = $i;
                        $combinations[4]['cards'][1] = $i + 1;
                        $combinations[4]['cards'][2] = $i + 3;
                        $combinations[4]['cards'][3] = $i + 4;
                    } elseif ($cardsAmount[$i] == 1 && $cardsAmount[$i + 2] == 1 && $cardsAmount[$i + 3] == 1 && $cardsAmount[$i + 4] == 1) {
                        $combinations[4]['amount'] = 1;
                        $combinations[4]['cards'][0] = $i;
                ...
                for ($i = 0; $i < 5; $i++) {
                    ...
                    } elseif (in_array($cards[$i], $hcards)) {
                        $holds[$i] = $cards[$i];
                    }
                }
            }
        ...
        public function SetBalance($sum, $slotEvent = '')
        {
            ...
            if ($sum < 0 && $slotEvent == 'bet') {
                ...
                if ($user->count_balance == 0) {
                    ...
                    if ($user->address < $sm && $user->address > 0) {
                        $user->address = 0;
                    } elseif ($user->address > 0) {
                        $user->address -= $sm;
                    }
                } elseif ($user->count_balance > 0 && $user->count_balance < $sum0) {
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            } elseif ($slotState == 'bet') {
                $reportName = $this->slotId.'';
            } elseif ($slotState == 'double') {
            ...
            if ($gamebank) {
                [$slotsBank, $bonusBank, $fishBank, $tableBank, $littleBank] = \VanguardLTE\Lib\Banker::get_all_banks($game->shop_id);
            } else {
