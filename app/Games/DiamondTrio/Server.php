                    ...
                    if ($postData['slotEvent'] == 'getSettings') {
                        ...
                        for ($i = 0; $i <= 2000; $i++) {
                            ...
                            for ($m = 1; $m <= 5; $m += 2) {
                                if ($reels['reel'.$m][0] == $scatter) {
                                    $scatterReels[$m] = true;
                                } elseif ($reels['reel'.$m][1] == $scatter) {
                                    $scatterReels[$m] = true;
                                } elseif ($reels['reel'.$m][2] == $scatter) {
                                    $scatterReels[$m] = true;
                                }
                            }
                            $doubleWin = 0;
                            ...
                            if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                ...
                                } elseif ($totalWin + $doubleWin > 0 && $totalWin + $doubleWin <= $spinWinLimit && $winType == 'win') {
                                    $cBank = $slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : ''));
                                    if ($cBank < $spinWinLimit) {
                                        $spinWinLimit = $cBank;
                                    } else {
                        ...
                        if ($scattersCount == 2 && $postData['gameCommand'] != 'respin') {
                            ...
                            if ($scatterReels[1] && $scatterReels[3]) {
                                $rNum = 5;
                            } elseif ($scatterReels[5] && $scatterReels[3]) {
                                $rNum = 1;
                            } elseif ($scatterReels[5] && $scatterReels[1]) {
                                $rNum = 3;
                            }
