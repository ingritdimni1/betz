            ...
            function get_($request, $game)
            {
                \DB::transaction(function () use ($game) {
                    try {
                        ...
                        if ($postData['slotEvent'] == 'gameInit') {
                        ...
                        } elseif ($postData['slotEvent'] == 'gameRefreshBalance') {
                            $balanceInCents = round(sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                        ...
                        } elseif ($postData['slotEvent'] == 'gamePing') {
                            $balanceInCents = round(sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                        ...
                        } elseif ($postData['slotEvent'] == 'sessionInfo') {
                        ...
                        } elseif ($postData['slotEvent'] == 'gameTakeWin') {
                            $balanceInCents = round(sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                        ...
                        } elseif ($postData['slotEvent'] == 'gamePick') {
                            $balanceInCents = round(sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                            if ($_POST['pick'] == 0) {
                            ...
                            if ($winType == 'bonus') {
                                ...
                                for ($pr = 0; $pr < count($winLimitBonus); $pr++) {
                                    if ($slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : '')) >= $winLimitBonus[$pr] * $postData['slotBet']) {
                            ...
                            for ($i = 0; $i <= 2000; $i++) {
                                ...
                                for ($k = 0; $k < $postData['slotLines']; $k++) {
                                    ...
                                    for ($kl = 0; $kl < count($linesId0[$k]); $kl++) {
                                        if ($linesId0[$k][$kl] == 1) {
                                            $linesId0[$k][$kl] = 4;
                                        } elseif ($linesId0[$k][$kl] == 2) {
                                            $linesId0[$k][$kl] = 3;
                                        } elseif ($linesId0[$k][$kl] == 3) {
                                            $linesId0[$k][$kl] = 2;
                                        } elseif ($linesId0[$k][$kl] == 4) {
                                            $linesId0[$k][$kl] = 1;
                                        }
                                    }
