                        ...
                        switch ($aid) {
                            ...
                            case 'spin':
                                ...
                                for ($i = 0; $i <= 2000; $i++) {
                                    ...
                                    } elseif ($winType != 'win' && $totalWin > 0) {
                                    } elseif ($totalWin <= $cBank) {
                                        break;
                                    }
                                }
                                $freeState = '';
