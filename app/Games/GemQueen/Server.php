                    ...
                    try {
                        ...
                        if ($postData['slotEvent'] == 'spin' || $postData['slotEvent'] == 'freespin' || $postData['slotEvent'] == 'respin') {
                            ...
                            if ($postData['slotEvent'] == 'respin') {
                                for ($r = 1; $r <= 5; $r++) {
                                    if ($tmpChangeMap[$r - 1][2] < 0 && $tmpChangeMap[$r - 1][1] >= 0 && $tmpChangeMap[$r - 1][0] >= 0) {
                                        ...
                                        $rr['reel'.$r][0] = 'EMPTY';
                                    } elseif ($tmpChangeMap[$r - 1][2] >= 0 && $tmpChangeMap[$r - 1][1] < 0 && $tmpChangeMap[$r - 1][0] >= 0) {
                            ...
                            for ($i = 0; $i <= 2000; $i++) {
                                ...
                                } elseif ($scattersCount >= 3 && $winType != 'bonus' || $scattersCount > 5) {
                                } else {
                            ...
                            if ($postData['slotEvent'] == 'freespin') {
                                ...
                                if ($totalWin > 0 || $Events0 != '') {
                                    ...
                                    $roundEnded = 'false';
                                } elseif ($slotSettings->GetGameData('GemQueenWaitFreeGames') == 1) {
