                    ...
                    try {
                        ...
                        switch ($aid) {
                                ...
                                for ($i = 0; $i <= 2000; $i++) {
                                    ...
                                    for ($r = 1; $r <= 5; $r++) {
                                        ...
                                        if ($reels2['reel'.$r][0] == -1 && $reels2['reel'.$r][1] == -1 && $reels2['reel'.$r][2] == -1 && $reels['reel'.$r][0] == 9 && $reels['reel'.$r][1] == 9 && $reels['reel'.$r][2] == 9) {
                                            $topA = '3';
                                        } elseif ($reels2['reel'.$r][1] == -1 && $reels2['reel'.$r][2] == -1 && $reels['reel'.$r][1] == 9 && $reels['reel'.$r][2] == 9) {
                                            $topA = '2';
                                        } elseif ($reels2['reel'.$r][0] == -1 && $reels2['reel'.$r][1] == -1 && $reels['reel'.$r][0] == 9 && $reels['reel'.$r][1] == 9) {
                                            $topA = '2';
                                        }
                                        for ($p = 0; $p <= 2; $p++) {
                            ...
                            case 'initGambleLadder':
                                ...
                                for ($i = 0; $i < count($ladder); $i++) {
                                    if ($ladder[$i] < 0) {
                                        ...
                                        if ($bet * $ladder[$i] < $gambleAmount && $ladder[$i] >= 0) {
                                            $LadderStep = -1;
                                            $LadderStep1 = $i + 1;
                                        } elseif ($gambleAmount == ($bet * $ladder[$i]) && $ladder[$i] >= 0) {
                                            $LadderStep = $i;
                                        }
                                    }
                                }
                                ...
                                } elseif ($LadderStep <= 10 && $LadderStep >= 0) {
                                    if ($LadderStep == 6) {
                                        $LadderStep0 = 4;
                                        $LadderStep1 = $LadderStep + 1;
                                    } else {
                                ...
                                } elseif ($LadderStep <= 14 && $LadderStep >= 0) {
                                    if ($LadderStep == 12) {
                                        $LadderStep0 = 10;
                                        $LadderStep1 = $LadderStep + 1;
                                    } else {
                                ...
                                } elseif ($LadderStep1 <= 10 && $LadderStep < 0) {
                                    if ($LadderStep1 == 6) {
                                        $LadderStep0 = 4;
                                    } else {
                                        $LadderStep0 = $LadderStep1 - 1;
                                    }
                                } elseif ($LadderStep1 <= 14 && $LadderStep < 0) {
                                    if ($LadderStep1 == 12) {
                                        $LadderStep0 = 10;
                                    } else {
                                        $LadderStep0 = $LadderStep1 - 1;
