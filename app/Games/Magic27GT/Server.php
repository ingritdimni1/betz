                            ...
                            for ($i = 0; $i <= 2000; $i++) {
                                                            ...
                                                            for ($step3 = 0; $step3 < 3; $step3++) {
                                                                if ($winSymbolsAnim[2][$step3] == '') {
                                                                    ...
                                                                    if ($s1 == $wild && $s2 == $wild && $s3 == $wild) {
                                                                        ...
                                                                        $s2 = 'P_1';
                                                                        $s3 = 'P_1';
                                                                    } elseif ($s1 == $wild || $s2 == $wild || $s3 == $wild) {
                                                                        $wsp = '';
                                                                        for ($w = 1; $w <= 3; $w++) {
                                                                            if (${'s'.$w} != $wild) {
                                                                                $wsp = ${'s'.$w};
                                ...
                                if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                    ...
                                    if ($slotSettings->increaseRTP && $winType == 'win' && $totalWin < ($minWin * $postData['slotBet'] * $postData['slotLines'])) {
                                        ...
                                        } elseif ($totalWin + $mysteryWinCredit <= $spinWinLimit && $winType == 'bonus') {
                                        ...
                                        } elseif ($totalWin + $mysteryWinCredit > 0 && $totalWin + $mysteryWinCredit <= $spinWinLimit && $winType == 'win') {
                                            $cBank = $slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : ''));
                                            if ($cBank < $spinWinLimit) {
                                                $spinWinLimit = $cBank;
                                            } else {
                                        ...
                                        } elseif ($totalWin + $mysteryWinCredit == 0 && $winType == 'none') {
                                            break;
                                        }
                                    }
                                }
