                    ...
                    try {
                        ...
                        if ($postData['slotEvent'] == 'getSettings') {
                            ...
                            for ($i = 0; $i <= 2000; $i++) {
                                ...
                                } elseif ($slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : '')) < ($totalWin + $scattersWinTmp) && ($postData['slotEvent'] == 'freespin' || $winType == 'bonus')) {
                                } else {
                                    if ($slotSettings->GetGameData('AmazingStarsGTFreeGames') <= $slotSettings->GetGameData('AmazingStarsGTCurrentFreeGame') && $postData['slotEvent'] == 'freespin') {
                                        $scattersWin = 0;
                                        $totalWin = 0;
                            ...
                            } elseif ($postData['slotEvent'] != 'freespin' && $winType != 'bonus' && $totalWin > 0 && ! $isSlotJack && ! $isSlotJack0) {
