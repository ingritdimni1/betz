                    ...
                    try {
                        ...
                        switch ($gameData['slotEvent']) {
                            ...
                            case 'A/u283':
                                ...
                                } elseif ($boxPlayer[$boxId]['mainScore'] == 21) {
                                    $hitState = '3';
                                ...
                                if ($boxPlayer[2]['bet'] > 0 && $boxState1 == '1' && $boxId == 2) {
                                    ...
                                    if ($boxPlayer[2]['mainScore'] > 21) {
                                        ...
                                        $aState[2] = '01';
                                        $boxPlayer[2]['state'] = '9';
                                    } elseif ($boxPlayer[2]['mainScore'] == 21) {
                                        $hitState = '4';
                                        $aState[2] = '01';
                                        $boxPlayer[2]['state'] = '3';
                                    } else {
                                ...
                                } elseif ($boxPlayer[2]['bet'] > 0 && $boxState1 == '0' && $boxId == 1) {
                                    $splitState .= '00';
                                    if ($boxPlayer[1]['mainScore'] > 21) {
                                        $hitState = '9';
                                        $aState[1] = '01';
                                        $boxPlayer[1]['state'] = '3';
                                    } elseif ($boxPlayer[1]['mainScore'] == 21) {
                                        $hitState = '3';
                                        $aState[1] = '01';
                                        $boxPlayer[1]['state'] = '4';
                                    } else {
                                ...
                                if ($boxPlayer[5]['bet'] > 0 && $boxState1 == '1' && $boxId == 5) {
                                    ...
                                    if ($boxPlayer[5]['mainScore'] > 21) {
                                        ...
                                        $aState[5] = '01';
                                        $boxPlayer[5]['state'] = '9';
                                    } elseif ($boxPlayer[5]['mainScore'] == 21) {
                                        $hitState = '3';
                                        $aState[5] = '01';
                                        $boxPlayer[5]['state'] = '4';
                                    } else {
                                ...
                                } elseif ($boxPlayer[5]['bet'] > 0 && $boxState1 == '0' && $boxId == 4) {
                                    $splitState .= '00';
                                    if ($boxPlayer[4]['mainScore'] > 21) {
                                        $hitState = '9';
                                        $aState[4] = '01';
                                        $boxPlayer[4]['state'] = '3';
                                    } elseif ($boxPlayer[4]['mainScore'] == 21) {
                                        $hitState = '3';
                                        $aState[4] = '01';
                                        $boxPlayer[4]['state'] = '4';
                                    } else {
                                ...
                                if ($boxPlayer[8]['bet'] > 0 && $boxState1 == '1' && $boxId == 8) {
                                    ...
                                    if ($boxPlayer[8]['mainScore'] > 21) {
                                        ...
                                        $aState[8] = '01';
                                        $boxPlayer[8]['state'] = '9';
                                    } elseif ($boxPlayer[8]['mainScore'] == 21) {
                                        $hitState = '3';
                                        $aState[8] = '01';
                                        $boxPlayer[8]['state'] = '4';
                                    } else {
                                ...
                                } elseif ($boxPlayer[8]['bet'] > 0 && $boxState1 == '0' && $boxId == 7) {
                                    $splitState .= '00';
                                    if ($boxPlayer[7]['mainScore'] > 21) {
                                        $hitState = '9';
                                        $aState[7] = '01';
                                        $boxPlayer[7]['state'] = '3';
                                    } elseif ($boxPlayer[7]['mainScore'] == 21) {
                                        $hitState = '3';
                                        $aState[7] = '01';
                                        $boxPlayer[7]['state'] = '4';
                                    } else {
                            ...
                            case 'A/u286':
                                ...
                                } elseif ($boxPlayer[2]['bet'] > 0 && $boxState1 == '0') {
                                    $splitState .= '00';
                                    if ($boxPlayer[1]['mainScore'] > 21) {
                                        $hitState = '9';
                                        $aState[1] = '01';
                                ...
                                } elseif ($boxPlayer[8]['bet'] > 0 && $boxState1 == '0') {
                                    $splitState .= '00';
                                    if ($boxPlayer[7]['mainScore'] > 21) {
                                        $hitState = '9';
                                        $aState[7] = '01';
                            ...
                            case 'A/u284':
                                ...
                                if ($boxPlayer[2]['bet'] > 0 && $boxState1 == '1' && $tmpPar[1] == 0) {
                                    $splitState .= '01';
                                    $boxPlayer[2]['state'] = '4';
                                } elseif ($boxPlayer[2]['bet'] > 0 && $boxState1 == '0' && $tmpPar[1] == 0) {
                                    $splitState .= '00';
                                    $boxPlayer[1]['state'] = '3';
                                } else {
                                    $splitState .= '00';
                                ...
                                if ($boxPlayer[5]['bet'] > 0 && $boxState1 == '1' && $tmpPar[1] == 1) {
                                    $splitState .= '01';
                                    $boxPlayer[5]['state'] = '4';
                                } elseif ($boxPlayer[5]['bet'] > 0 && $boxState1 == '0' && $tmpPar[1] == 1) {
                                    $splitState .= '00';
                                    $boxPlayer[4]['state'] = '3';
                                } else {
                                    $splitState .= '00';
                                ...
                                if ($boxPlayer[8]['bet'] > 0 && $boxState1 == '1' && $tmpPar[1] == 2) {
                                    $splitState .= '01';
                                    $boxPlayer[8]['state'] = '4';
                                } elseif ($boxPlayer[8]['bet'] > 0 && $boxState1 == '0' && $tmpPar[1] == 2) {
                                    $splitState .= '00';
                                    $boxPlayer[7]['state'] = '3';
                                } else {
                                    $splitState .= '00';
