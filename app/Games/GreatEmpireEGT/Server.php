                    ...
                    try {
                        ...
                        switch ($aid) {
                            ...
                            case 'choice':
                                ...
                                } elseif ($postData['bet']['choice'] == 1) {
                                    $slotSettings->slotFreeCount = 10;
                                    $holds = [
                                        1,
                                        3,
                                    ];
                                } elseif ($postData['bet']['choice'] == 2) {
                                    $holds = [2];
                                ...
                                for ($pr = 0; $pr < count($winLimitBonus); $pr++) {
                                    if ($slotSettings->GetBank('bonus') >= $winLimitBonus[$pr] * $betline) {
                            ...
                            case 'bet':
                                ...
                                for ($i = 0; $i <= 2000; $i++) {
                                    ...
                                    if ($slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom)) {
                                        ...
                                        } elseif ($scattersCount >= 3 && $winType == 'bonus' && $slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : '')) < ($betline * 500 + $totalWin)) {
                                            $winType = 'none';
