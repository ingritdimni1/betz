            ...
            for ($r = 1; $r <= 6; $r++) {
                for ($p = 0; $p <= 6; $p++) {
                    ...
                    if ($reels['reel'.$r][$p] == 117) {
                        $reels['reel'.$r][$p] = 333;
                    } elseif ($reels['reel'.$r][$p] == 118) {
                        $reels['reel'.$r][$p] = 333;
                        $reels['reel'.($r + 1)][$p] = 333;
                        $reels['reel'.($r - 1)][$p] = 333;
                    } elseif ($reels['reel'.$r][$p] == 119) {
                        $reels['reel'.$r][$p] = 333;
                        $reels['reel'.($r + 1)][$p] = 333;
                        $reels['reel'.($r - 1)][$p] = 333;
                    } elseif ($reels['reel'.$r][$p] == 120) {
                        $reels['reel'.$r][$p] = 333;
                        $reels['reel'.($r + 1)][$p] = 333;
                        $reels['reel'.($r - 1)][$p] = 333;
                    } elseif ($reels['reel'.$r][$p] == 121) {
                        $reels['reel'.$r][$p] = 333;
                        $reels['reel'.($r + 1)][$p] = 333;
                        $reels['reel'.($r - 1)][$p] = 333;
                    } else {
                        ...
                        if ($reels['reel'.$r][$p] == 27 || $reels['reel'.$r][$p] == 28) {
                            $reels['reel'.$r][$p] = 12;
                        } elseif ($reels['reel'.$r][$p] >= 29 && $reels['reel'.$r][$p] <= 55) {
                            $reels['reel'.$r][$p] = 9;
                        } elseif ($reels['reel'.$r][$p] >= 56 && $reels['reel'.$r][$p] <= 82) {
                            $reels['reel'.$r][$p] = 8;
                        } elseif ($reels['reel'.$r][$p] >= 83 && $reels['reel'.$r][$p] <= 109) {
                            $reels['reel'.$r][$p] = 7;
                        } elseif ($reels['reel'.$r][$p] == 110) {
                            $reels['reel'.$r][$p] = 6;
                        } elseif ($reels['reel'.$r][$p] == 111) {
                            $reels['reel'.$r][$p] = 4;
                        } elseif ($reels['reel'.$r][$p] == 112) {
                            $reels['reel'.$r][$p] = 5;
                        } elseif ($reels['reel'.$r][$p] == 113) {
                            $reels['reel'.$r][$p] = 3;
                        } elseif ($reels['reel'.$r][$p] == 114) {
                            $reels['reel'.$r][$p] = 2;
                        } elseif ($reels['reel'.$r][$p] == 115) {
                            $reels['reel'.$r][$p] = 1;
                        } elseif ($reels['reel'.$r][$p] == 116) {
                            $reels['reel'.$r][$p] = 0;
                        }
                    }
                }
