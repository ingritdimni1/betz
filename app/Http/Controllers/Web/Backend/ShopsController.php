...
namespace VanguardLTE\Http\Controllers\Web\Backend
{
    ...
    class ShopsController extends \VanguardLTE\Http\Controllers\Controller
    {
        ...
        public function index(\Illuminate\Http\Request $request)
        {
            ...
            $shops = $shops->groupBy('shops.id', 'shops.name', 'shops.balance', 'shops.frontend', 'shops.currency', 'shops.percent', 'shops.max_win', 'shops.shop_limit', 'shops.is_blocked', 'shops.access', 'shops.country', 'shops.os', 'shops.device',
                'shops.orderby', 'shops.user_id', 'shops.pending', 'shops.rules_terms_and_conditions',
                'shops.rules_privacy_policy', 'shops.rules_general_bonus_policy', 'shops.rules_why_bitcoin',
                'shops.rules_responsible_gaming', 'shops.happyhours_active', 'shops.progress_active', 'shops.invite_active',
                'shops.welcome_bonuses_active', 'shops.sms_bonuses_active', 'shops.wheelfortune_active')->paginate(15)->withQueryString();
        ...
        public function store(\Illuminate\Http\Request $request)
        {
            ...
            $queryResult = DB::SELECT("SET NOCOUNT ON;exec CreateNewStore @StoreName='".$data['name']."', @Percent='".$data['percent']."', @UserID=".auth()->user()->id);
        ...
        {
            $data = $request->all();
            if (! \Illuminate\Support\Arr::get($data, 'type')) {
                $data['type'] = 'add';
            }
